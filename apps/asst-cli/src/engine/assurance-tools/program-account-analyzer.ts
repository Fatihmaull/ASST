 ...
 */
export const programAccountAnalyzerTool = tool(
  async (input) => {
    ...
    const accountData = await accountInfoRes.json() as any;
    ...
    const programAccountsData = await programAccountsRes.json() as any;
