...
function createGoogleModel(modelId: string) {
...
function createModel(modelId: string) {
  if (modelId.startsWith("gemini")) return createGoogleModel(modelId);
...
export const SUB_AGENT_CONFIGS: SubAgentConfig[] = [
  {
    ...
    tools: [programAccountAnalyzerTool, readFileTool, solanaRpcReadTool],
  ...
  },
  {
    ...
    tools: [solanaRpcReadTool, accountStateSnapshotTool],
  ...
  },
  {
    ...
    systemPromptPrefix: "You are the Report Synthesizer sub-agent. Your job is to take raw findings from other security scanners and produce a professional, executive-quality security assessment report."
  }
];
